...
`;                     
   ...
   if (lien.match(/\.(mp4|gif)$/i)) {
    try {
        zk.sendMessage(dest, { video: { url: lien }, caption:infoMsg + menuMsg, footer: "Je suis *☹︎ POPKID*, déveloper POPKID TECH" , gifPlayback : true }, { quoted: ms });
    }
    catch (e) {
